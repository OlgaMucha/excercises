...
public class Calculator {
    ...
    public void setup(){
        ...
        switch (usersChoice) {
            ...
            case 5 -> {
                output = outputForRationalNumberSimplification(rationalNumber1);
                break;
            }
    ...
    public static String outputForOperations(RationalNumber rationalNumberFirst, RationalNumber rationalNumberSecond, RationalNumber rationalNumberResult, char sign){
    ...
    public static String outputForRationalNumberSimplification(RationalNumber rationalNumber){
    ...
    public static ArrayList<RationalNumber> rationalNumbersUserEntry(int numberOfRationalNumbersNeeded, Scanner scanner){
        ...
        if(numberOfRationalNumbersNeeded == 1) {
            RationalNumber firstRationalNumber = oneRationalUserEntry(scanner);
            ...
            RationalNumber secondRationalNumber = oneRationalUserEntry(scanner);
    ...
    private static RationalNumber oneRationalUserEntry(Scanner scanner) {

        String[] rationalNumberDetails = scanner.nextLine().split("/");
